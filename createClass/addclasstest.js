...
// //
// //         const addClassTemplate = document.querySelector('.modal');
// //
// //         editButton.addEventListener('click', () => {
// //             const addClassModal = addClassTemplate.cloneNode(true);
// //
// //             addClassModal.style.display = 'block'; // Отображение скрытого элемента
// //             document.body.append(addClassModal);
// //         });
// //
// //     }
// //
...
//         /* редактирование класса */
//
//         const editButton = document.querySelector('.edit-class-btn');
//         editButton.addEventListener('click', () => {
//             editClass();
//         })
//
